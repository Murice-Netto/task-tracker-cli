...
const handler: CommandHandler = async (
  ...
  await service.updateStatus(id, TaskStatus.IN_PROGRESS);
  console.log("✅ Task status updated!");
};

export const markTaskAsInProgressCMD: Command = {
  name: "mark-in-progress",
  description: "marks a task's status as in progress",
  example: "tas-tracker mark-in-progress [ID]",
  exec: handler,
};
